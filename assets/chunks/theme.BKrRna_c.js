...
const _sfc_main$z = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CtNjpSXs.js"), true ? __vite__mapDeps([0,1]) : void 0));
  ...
  setup(__props) {
    ...
    async function renderDiagram() {
      ...
      const { default: mermaid } = await __vitePreload(async () => {
        const { default: mermaid2 } = await import("./mermaid.core.CEB8Xc_N.js").then((n) => n.bG);
